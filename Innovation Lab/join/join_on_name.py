...
def matcher2(crawler_df, PP_df, join_result):
    crawler_df['name'].str.lower
    PP_df['busn_name'].str.lower
    for i in range(crawler_df.shape[0]):
        if crawler_df.loc[i, 'name']=='.' or join_result.loc[i, 'cust_idPP'] is not None:
            continue
...
if __name__ == '__main__':
    ...
    PP_df = pd.read_csv("../../../Innovation Lab/Airlines_Travel sellers in Paypal.csv", usecols=use_cols_for_PP)
